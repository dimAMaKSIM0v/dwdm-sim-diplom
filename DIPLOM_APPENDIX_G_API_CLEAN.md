...
Листинг Г.1 — Создание объекта Network
...
Листинг Г.2 — Добавление узла в сеть
...
Листинг Г.4 — Создание волоконной линии
...
Листинг Г.5 — Получение затухания волокна
...
Листинг Г.6 — Получение коэффициента дисперсии
...
Листинг Г.7 — Расчет потерь в волокне
...
Листинг Г.8 — Расчет количества сварок
...
Листинг Г.9 — Создание DWDM канала
...
Листинг Г.10 — Расчет частоты из длины волны
...
Листинг Г.11 — Получение энергетического бюджета
...
Листинг Г.12 — Определение номера канала ITU-T
...
Листинг Г.13 — Создание оборудования EDFA
...
Листинг Г.14 — Получение вносимых потерь
...
Листинг Г.15 — Получение усиления EDFA
...
### 2.3 PowerBudgetCalculator

Путь: core/calculators/power_budget.py

Расчет бюджета мощности.

Листинг Г.18 — Использование PowerBudgetCalculator
...
Листинг Г.19 — Использование AmplifierPlacer
...
Параметры: channel_id: str — ID канала
Возвращает: количество размещенных усилителей
...
Листинг Г.20 — Использование FrequencyPlan
...
Листинг Г.21 — Использование TopologyManager
...
Листинг Г.22 — Поиск кратчайшего пути
...
Листинг Г.23 — Использование TopologyAnalyzer
...
Листинг Г.24 — Использование TrafficManager
...
Листинг Г.25 — Получение матрицы трафика
...
Листинг Г.26 — Использование SimulationManager
...
Листинг Г.27 — Сохранение и загрузка проектов
...
### 5.1 Создание простой сети

Листинг Г.28 — Создание простой сети
...
Листинг Г.29 — Расчет дисперсии для канала
...
### 5.3 Расчет бюджета мощности

Листинг Г.30 — Расчет бюджета мощности
...
### 5.4 Автоматическое размещение усилителей

Листинг Г.31 — Автоматическое размещение усилителей
...
### 5.5 Анализ топологии

Листинг Г.32 — Анализ топологии сети
...
Листинг Г.33 — Поиск маршрутов между узлами
...
### 6.1 Добавление нового типа оборудования

Листинг Г.34 — Добавление нового типа оборудования
...
### 6.2 Добавление нового калькулятора

Листинг Г.35 — Создание нового калькулятора
...
### 7.1 Пример unit-теста

Листинг Г.36 — Unit-тест для модели Fiber
